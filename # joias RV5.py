# joias RV5
# bom
# 1 forma geométrica, cor forte
# pontuação e nivel fora do tabuleiro
# Alterações:
#Aumento da Altura da Tela: A altura da tela foi aumentada para 
# acomodar a exibição da pontuação e do nível.

#Ajuste na Posição do Tabuleiro: O tabuleiro agora começa a 
# ser desenhado 60 pixels abaixo do topo da tela para deixar 
