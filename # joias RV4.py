# joias RV4
# placar e nivel no tabuleiro, cor forte

# RV3 erro é por falta de biblioteca de som
# vamos continuar sem som
# jogo esta bom, mas trabalhando para deixar a caixa da pontuação e nivel 
#fora do tabuleiro
...
largura_tela, altura_tela = 480, 480
