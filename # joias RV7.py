# joias RV7
# incluindo novas formas geométricas
# inicia com 3 formas geom
# dificil, verificar bug
#adicionar mais formas geométricas, como triângulos e círculos, 
# e ajustar a lógica para que apenas formas geométricas idênticas 
# na cor possam ser combinadas. Isso tornará o jogo mais interessante e desafiador.
...
# Configurações das cores e formas
CORES_JOIAS = [
...
FORMAS_JOIAS = ['quadrado', 'circulo', 'triangulo']
    ...
    for y in range(linhas):
        for x in range(colunas):
            ...
            if forma == 'quadrado':
                ...
                pygame.draw.circle(tela, cor, (x * largura_joia + largura_joia // 2, y * altura_joia + 60 + altura_joia // 2), largura_joia // 2)
